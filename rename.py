...
###from lifq.lifq_3d import Lifq_3d
##import matplotlib.pyplot as plt
##import numpy as np
####
####img = plt.imread("signal3val.png");
####
#####testnumpy = np.array(["ouiuoui", 3], dtype = np.string)
####
####
####lif = Lifq_2d()
####lif.fit(img)
...
####img = plt.imread("signal3val.png");
####
#####testnumpy = np.array(["ouioueiu", 3], dtype = np.string)
####
####
####lif = Lifq_2d()
####lif.fit(img)
...
##img = plt.imread("signal3val.png");
##
###testnumpy = np.array(["veryyes", 3], dtype = np.string)
##
##
##lif = Lifq_2d()
##lif.fit(img)
...
imagePath = 'pics/surprisedmega.png'
rWeight = 0.2989;
gWeight = 0.5870;
bWeight = 0.1140;
...
# display the source image grayscaled with the RGB weights defined at the top
# of this code
#plt.imshow(grayImg, cmap=plt.get_cmap('gray'), vmin=0.0, vmax=1.0) # tweak vmin and vmax for some degradation
...
# Here we use the LIFQ to actually do neuron stuff
lif = Lifq_2d()
